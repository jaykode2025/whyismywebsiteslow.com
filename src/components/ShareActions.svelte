...
<div class="space-y-4">
  <div class="rounded-2xl border border-white/10 bg-white/5 p-3">
    ...
    <div class="mt-2 flex flex-col gap-3 md:flex-row md:items-center">
      ...
      <button
        class="rounded-full border border-white/10 px-4 py-2 text-xs uppercase tracking-[0.18em] text-slate-200 transition hover:border-sky-400/60 hover:text-sky-100"
        type="button"
  ...
  <div class="rounded-2xl border border-white/10 bg-white/5 p-3">
    ...
    <div class="mt-2 flex flex-col gap-3">
      ...
      <button
        class="self-start rounded-full border border-white/10 px-4 py-2 text-xs uppercase tracking-[0.18em] text-slate-200 transition hover:border-emerald-300/60 hover:text-emerald-100"
        type="button"
